...
<body>
  ...
  <div class="form">
    ...
    <form class="login-form" id="login" method="post" action="php/login.php">
      <input type="text" name="usu" id="usu" placeholder="Usuario"/>
      <input type="password" name="pass" id="pass" placeholder="Contraseña"/>
      <button type="submit">login</button>
        <div id="erroresmsgs"></div>
      <p class="message">No estás registrado? <a href="suscribete.php">Registrate ahora</a></p>
    <p class="message">No recuerdas la contraseña? <a href="recoverpass.php">Click aquí</a></p>
    </form>
