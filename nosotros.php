...
<body>
	...
	<div id="fh5co-hotel-section">
        ...
        <div class="paquete">
            ...
            <div class="paquete-total" style="margin-bottom:0px">
            <h1>Visión</h1>
            <p>
Convertirnos en un referente turístico y a su vez promover el crecimiento de nuestra empresa, ofreciendo una información de calidad que ayude al cliente a despejar todas sus dudas y dar soluciones para  evitar posibles inconvenientes  (antes, durante o después de cada viaje)
            </p>
            
            <h1>Misión</h1>
            <p>
La empresa brinda una asistencia profesional a todos aquellos que necesiten un servicio de viaje. Damos un servicio a medida a todos nuestros clientes que desean viajar ya sea por vacaciones o negocios.<br>
Nuestro personal está debidamente capacitado para poder lograr superar las expectativas de nuestros clientes.
            </p>
            
            <h1>Misión</h1>
            <img src="images/valorers.png" width="100%" height="auto">
