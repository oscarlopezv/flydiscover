  ...
  <div class="form">
    ...
    <form class="login-form">
      ...
      <p class="message">Felicidades!<br>
       <a href="#">Tu perfil ha sido creado satisfactoriamente.</a><br>
        Se ha enviado un correo electronico al mail registrado,<br>
        con los detalles para la activación de la membresia.</p>
       <br><br>
