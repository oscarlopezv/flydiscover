...
<body>
		...
		<header id="fh5co-header-section">
			<div class="container">
				<div class="nav-header">
					...
					<h1 id="fh5co-logo">
                    	<div class="logo"><img src="images/logo3.png" width="100%" height="auto"> </div>
                    </h1>
  ...
  <div class="form">
    ...
    <form class="login-form" id="suscform" action="php/membresias.php" method="post">
      ...
      <textarea name="dir" placeholder="Dirección domiciliaria" id="dir"></textarea><br><p></p>
