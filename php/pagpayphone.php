<?php
    ...
    $fields = array(
       ...
       "clientTransactionId"=>  "$paquete", 
       "responseUrl"=>  "http://innovatourclub.com/confirm_payphone.php",
       "cancellationUrl"=>  "http://innovatourclub.com/cancel_payphone.phpng", 
       "lang"=>  "esp", 
       
       "reference"=>  "874631", 
       "phoneNumber"=>  "+593".substr($telp,1), 
       "email"=>  "$mailp",
        "optionalParameter"=>  "$nomp||$detp",
   ...
   //echo "<a href='$url'>$url</a> ";
    if ($url!=''){
        ...
        $msjfin .= $msj.'<br>';
        foreach ($msjs as &$valor) {
            $msjfin .= $valor['errorDescriptions'][0].'<br>';
        }
    }
