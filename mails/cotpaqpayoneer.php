  ...
  <td class="textodos"><br><br>
    ...
    Tu cotizacion ha sido confirmada, con la siguiente descripción:<br><br>
     ...
     Id de cotización: <?php echo strtoupper($row["idcotizacionespaq"]) ?> <br>
      ...
      Para poder realizar el pago,<br> debera de dar click en el siguiente link o copiar y pegar en el navegador de su preferencia:<br>
      <a href="<?php echo $row["payoneer"] ?>"><?php echo $row["payoneer"] ?></a> <br>
 <br>
</td>
     </tr> 
