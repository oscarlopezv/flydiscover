...
<table class="general" border="0" align="center">
  ...
  <td class="textodos"><br><br>
    Sr(a) <h3><?php echo strtoupper($row["cliente"]) ?></h3><br>
    <br>
    Tu cotizacion ha sido confirmada, con la siguiente descripción:<br><br>
      <h4>
     Id de cotización: <?php echo strtoupper($row["idcotizacionespaq"]) ?> <br>
         Tipo: <?php echo strtoupper($row["tipo"]) ?> <br>
      Lugar de Origen: <?php echo strtoupper($row["origen"]) ?> <br>
          Lugar de Destino: <?php echo strtoupper($row["destino"]) ?> <br>
      ...
      Infantes: <?php echo strtoupper($row["infante"]) ?> <br>
      Precio: <?php echo strtoupper($row["precio"]) ?> <br>
      Observación: <?php echo strtoupper($row["observacion"]) ?> <br>
        <br></h4>
      <p></p>
      Para poder realizar el pago<br>
      debera hacerla por transferencia bancaria o deposito,<br> en la siguiente cuenta bancaria: <br><br><h4>
        Banco Pichincha <br>
        Cuenta Corriente 2100135117 <br>
        a nombre de: Mildred Jaramillo Arboleda</h4>
 <br>
</td>
     </tr>
