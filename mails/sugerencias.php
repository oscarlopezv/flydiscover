...
$sql=new conectar();
$sql->mysqlsrv();
$query="select a.*,CONCAT(b.nombres,' ',b.apellidos) cliente from sugerencias a
inner join clientes b on b.idclientes=a.idcliente
where a.idsugerencias=".base64_decode($_GET["idv"]);
...
<table class="general" border="0" align="center">
  ...
  <td class="textodos"><br><br>
    Has recibido una sugerencia de <?php echo strtoupper($row["cliente"]) ?><br>
    <br>
